...
/**
 * Class cf7pa-Stripe_Webhook_State.
 *
...
class Stripe_Webhook_State {
	const OPTION_LIVE_MONITORING_BEGAN_AT = 'cf7pa-stripe_wh_monitor_began_at';
	const OPTION_LIVE_LAST_SUCCESS_AT     = 'cf7pa-stripe_wh_last_success_at';
	const OPTION_LIVE_LAST_FAILURE_AT     = 'cf7pa-stripe_wh_last_failure_at';
	const OPTION_LIVE_LAST_ERROR          = 'cf7pa-stripe_wh_last_error';

	const OPTION_TEST_MONITORING_BEGAN_AT = 'cf7pa-stripe_wh_test_monitor_began_at';
	const OPTION_TEST_LAST_SUCCESS_AT     = 'cf7pa-stripe_wh_test_last_success_at';
	const OPTION_TEST_LAST_FAILURE_AT     = 'cf7pa-stripe_wh_test_last_failure_at';
	const OPTION_TEST_LAST_ERROR          = 'cf7pa-stripe_wh_test_last_error';
